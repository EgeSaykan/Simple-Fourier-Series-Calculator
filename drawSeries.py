...
def drawSeries():
    ...
    theCoefficientList = cf.read_coefficients_from_file() # read coefficients from file, generated by coefficientMaker.py
    ...
    while run: # loop to keep the window open
        ...
        for i, color in enumerate(pointsList):
            ...
            # coof = 0
            win.set_at((floor(color.real), floor(color.imag)), (50 - 35 * coof, 190 - 175 * coof, 145 - 130 * coof, 255) )
